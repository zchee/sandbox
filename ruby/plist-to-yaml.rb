...
# https://gist.github.com/kch/507914/de08ebc547f027944ddda951a0574bd4d80faf8c
# encoding: UTF-8
require 'yaml'
require "base64"
...
class PList < BasicObject
  ...
  process_element_named(:dict   ) { |elt| elt.elements.partition { |e| e.name == 'key' }.inject { |keys, values| keys.zip(values) }.inject({}) { |h, (k, v)| h[k.text] = process_element(v); h } }
